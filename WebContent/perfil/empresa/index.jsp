		                ...
		                <form action="../Atualizar.do" method="post">
		                    <div class="row">
		                    	<div class="col-6 tudo-esquerda">
		                    		...
		                    		<input name="username" value="${sessao_user.userName}" type="text" readonly disabled class="username-wrapper"> <br>
				                	...
				                	<input name="cpf" value="${sessao_user.cnpj}" type="text" readonly disabled class="username-wrapper"> <br>
		                    	</div>
			                    ...
			                    <div class="row">
				                    ...
				                    <div class="col-3">
				                        <button type="button" style="text-align: center;"
				                            class="botao-delete" data-toggle="modal"
