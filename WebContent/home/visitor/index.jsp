    ...
    <body>
		<div class="bodyContent">
			<nav class="navbar">
				...
				<div id="centerText">
					<svg id="Component_2_1" data-name="Component 2 – 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="328" height="36" viewBox="0 0 328 36">
			...
			<footer class="fullFooter">
				<div>
					<p>Empresas que participam do app</p>
				</div>
				<div id="companies">
