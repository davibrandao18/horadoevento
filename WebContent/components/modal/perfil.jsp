...
<div class="modal fade" id="modalExcluirUsuario" tabindex="-1" role="dialog" aria-labelledby="excluirUsuarioLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="/horadoevento/Remover.do" method="post">
                <div class="modal-body">
                    ...
                    Voc� tem certeza que deseja apagar o seu perfil? Esta ação não poderá ser desfeita.
