...
<nav class="navbar navbar-dark theme-navbar">
    <div class="display-none-mobile col-md-4 d-flex justify-content-start" style="align-items: center;">
        <c:if test='${tipo_entidade.equals("usuario")}'>
            <a href="/horadoevento/home/member/">
                <svg id="Component_2_1" data-name="Component 2 â€“ 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <text id="HORA_DO_EVENTO" data-name="HORA DO EVENTO" transform="translate(0 31)" class="tagText"
                    ...
                    <g id="Bitmap" transform="translate(292)">
                        <image style="filter: invert(0);" id="Bitmap-2" data-name="Bitmap" width="36" height="36"
        ...
        <c:if test='${tipo_entidade.equals("empresa")}'>
            <a href="/horadoevento/dashboard-empresa/">
                <svg id="Component_2_1" data-name="Component 2 â€“ 1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="328" height="36" viewBox="0 0 328 36">
                    <text id="HORA_DO_EVENTO" data-name="HORA DO EVENTO" transform="translate(0 31)" class="tagText"
                        font-size="20" font-family="PressStart2P, 'Press Start 2P'" letter-spacing="0.011em">
    ...
    <div class="col-10 col-md-4 d-flex justify-relative-mobile">
        <form class="form-inline bg-light rounded p-0" action="/horadoevento/pesquisa/Pesquisa.do" method="get">
            <input class="form-control bg-light border-light" type="search" aria-label="Search" name="username"
                placeholder="Busque aqui!" type="text" />
        </form>
    </div>
...
<div class="collapse " id="menuOpcoes">
	<div class="collapseNavMenu p-4 d-flex justify-content-end">
	    <ul style="list-style: none;">
	        ...
	        <c:if test='${tipo_entidade.equals("usuario")}'>
	            <li class="text-right"><a href="/horadoevento/view/inscricao/"
	                    style="text-decoration: none;">Inscrições</a></li>
	        </c:if>
