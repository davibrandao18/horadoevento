        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control bginput-hde" name="data-hora" id="data-hora"
                ...
                <c:forEach var="tag" items="${lista}">
                    <div class="form-check">
                        <c:if test="${tag.checado == 1}">
                            <input class="form-check-input" name="checkbox" type="checkbox" value="${tag.id}"
