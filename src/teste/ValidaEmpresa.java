...
public class ValidaEmpresa {
	...
	public static boolean letrasENumeros(String senha)
	{
		...
		{			
			if (Character.isDigit(array[i])) existeNumero = true; // verifica se o char ̩ um numero
			if (! Character.isDigit(array[i])) existeLetra = true; // verifica se o char ̩ uma letra
		}
